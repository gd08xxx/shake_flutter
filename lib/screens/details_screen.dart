...
class _DetailsScreenState extends State<DetailsScreen>
  ...
  // Size-based pricing with Hong Kong dollar values
  final Map<String, double> sizePrices = {'S': 38, 'M': 45, 'L': 52, 'XL': 58};
  ...
  void initState() {
    ...
    _imageScaleAnimation = Tween<double>(begin: 1.0, end: 1.0).animate(
  ...
  Color get itemPrimaryColor =>
      widget.item['primaryColor'] ?? widget.backgroundColor;
  Color get itemSecondaryColor =>
      widget.item['secondaryColor'] ?? widget.containerColor;
  Color get itemAccentColor =>
      widget.item['accentColor'] ?? widget.containerColor;

  // Get current price based on selected size
  double get currentPrice => sizePrices[selectedSize] ?? 45;
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                ...
                                gradient: LinearGradient(
                                  ...
                                  colors: [itemSecondaryColor, itemAccentColor],
                                ),
                                border: Border.all(
                                  color: Colors.white.withOpacity(0.3),
                                  width: 2,
